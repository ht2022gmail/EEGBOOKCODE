...
[px_welch, f_welch, cl_welch] = ...
    pwelch(x, win, overlap, nfft, EEG.srate, 'ConfidenceLevel', 0.95);
...
%% Bandpass filtering:
x_delta = bandpass(x, [1 4], EEG.srate);
x_theta = bandpass(x, [4 8], EEG.srate);
x_alpha = bandpass(x, [8 13], EEG.srate);
x_beta = bandpass(x, [13 30], EEG.srate);
x_gamma = bandpass(x, [30 50], EEG.srate);
